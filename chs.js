...
var cnItems = {
    ...
    "Getting 1 xp per in-game minute to Running": "跑步时每分钟(游戏内时间)获得 1 经验",
    "Getting 1 xp per in-game minute to Farming": "耕作每分钟(游戏内时间)获得 1 经验",
    "Getting 1 xp per in-game minute to Weightlifting": "举重每分钟(游戏内时间)获得 1 经验",
    "Getting 1 xp per in-game minute to Spatial awareness": "空间感知每分钟(游戏内时间)获得 1 经验",
    "[off-hand]": "[副手]",
    "[torso]": "[躯干]",
    "[shield]": "[盾牌]",
    "[Book]": "[书籍]",
...
var cnRegReplace = new Map([
    ...
    [/^(.+) partially blocked, was hit for (.+) dmg$/, '$1 被击中但是格挡了部分伤害，受到 $2 伤害'],
